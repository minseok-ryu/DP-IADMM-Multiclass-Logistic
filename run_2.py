...
# main("MNIST","10", "ObjP", "dynamic_1", "1.0", "infty", "20000", "200") 
...
# for eps in ["0.05", "0.1", "1.0", "5.0"]:
#     main("MNIST","10", "OutP", "dynamic_1", "1.0", eps, "20000", "200") 
#     main("MNIST","10", "ObjP", "dynamic_1", "1.0", eps, "20000", "200") 

#     main("FEMNIST","small", "OutP", "dynamic_1", "1.0", eps, "20000", "200") 
#     main("FEMNIST","small", "ObjP", "dynamic_1", "1.0", eps, "20000", "200") 
...
#         main("FEMNIST","small", "ObjP", "dynamic_1", "100.0", eps, "5000", "100",  "5", bound) 